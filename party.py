...
def is_mel(name, email):
    """ Is this user Mel?
            ...
            True
            >>> is_mel('Alena Kruchkova','alena@krucrew.com')
            False
...
def get_treats():
    ...
    One day, I'll move this into a database! -- Balloonicorn
        ...
        >>> get_treats()
        [{'who': 'Heather', 'type': 'dessert', 'description': 'Chocolate mousse'}, {'who': 'Joel', 'type': 'dessert', 'description': 'Cardamom-Pear pie'}, {'who': 'Meggie', 'type': 'appetizer', 'description': 'Humboldt Fog cheese'}, {'who': 'Cynthia', 'type': 'dessert', 'description': 'Lemon bars'}, {'who': 'David', 'type': 'appetizer', 'description': 'Mini-enchiladas'}, {'who': 'Kari', 'type': 'drink', 'description': 'Sangria'}, {'who': 'Denise', 'type': 'dessert', 'description': 'Chocolate-raisin cookies'}, {'who': 'Lavinia', 'type': 'dessert', 'description': 'Brownies'}]

        >>> get_treats([])
        Traceback (most recent call last):
          File "<stdin>", line 1, in <module>
        TypeError: get_treats() takes no arguments (1 given)
